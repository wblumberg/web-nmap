        ...
        "sources": [
            {
                ...
                "zarr_decode_worker": getattr(src, 'zarr_decode_worker', False),
                "zarr_stream_concurrency": getattr(src, 'zarr_stream_concurrency', None),
                "zarr_preserve_native_dtype": getattr(src, 'zarr_preserve_native_dtype', False),
                "zarr_cache_decoded": getattr(src, 'zarr_cache_decoded', True),
                "zarr_chunk_cache_enabled": getattr(src, 'zarr_chunk_cache_enabled', False),
                "zarr_chunk_cache_max_bytes": getattr(src, 'zarr_chunk_cache_max_bytes', None),
                "zarr_chunk_cache_ttl_ms": getattr(src, 'zarr_chunk_cache_ttl_ms', None),
                "gpu_frame_budget_bytes": getattr(src, 'gpu_frame_budget_bytes', None),
                "gpu_upload_ahead_frames": getattr(src, 'gpu_upload_ahead_frames', None),
